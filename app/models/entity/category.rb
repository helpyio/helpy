module Entity
  class Category < Base
    ...
    expose :rank#, documentation: {type: 'String', desc: 'The rank can be used to determine the ordering of categories'}
    expose :front_page#, documentation: {type: 'String', desc: 'Whether or not the category should appear on the front page'}
